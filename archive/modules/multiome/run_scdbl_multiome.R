...
parser <- ArgumentParser(description='Run scDblFinder doublet detection for Multiome data')
...
# Load H5 data - for multiome, this returns a list with "Gene Expression" and "Peaks"
counts_raw <- Read10X_h5(h5_file)
...
writeLines(c(
  paste("scDblFinder Summary for", args$sample_name, "(Multiome)"),
  paste("====================================="),
